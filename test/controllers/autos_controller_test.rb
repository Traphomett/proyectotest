...
class AutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto" do
    assert_difference("Auto.count") do
      post autos_url, params: { auto: { año: @auto.año, estado: @auto.estado, marca: @auto.marca, modelo: @auto.modelo, precio: @auto.precio, tipo: @auto.tipo } }
    end
  ...
  test "should update auto" do
    patch auto_url(@auto), params: { auto: { año: @auto.año, estado: @auto.estado, marca: @auto.marca, modelo: @auto.modelo, precio: @auto.precio, tipo: @auto.tipo } }
